...
export function StatsDonutChart({ size, center, innerRadius, backgroundColor, borderColor, totalAmount, segments, emptyText, onSegmentPress }: Props) {
        ...
        <Svg width={size} height={size}>
          {segments.map((segment) => (
            <React.Fragment key={segment.name}>
              <Path d={segment.path} fill={segment.color} onPress={() => onSegmentPress(segment.categoryId)} />
